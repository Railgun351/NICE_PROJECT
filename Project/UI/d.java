...
public class d extends JFrame {
 ...
 //백엔드 메인로직
    	   List<FactoryItemFromMenu> items = new ArrayList<>();
	        ...
	        List<StarDto> StarDtoList = empService.getStarDtoList();
...
//	        System.out.println(); // 개행
	  ...
	  //첫번째 요소 출력
	        ...
	        System.out.println(c1.getMembername() + ": " + c1.getTargetScore() + " " + c1.getReview() + " " + dateFormat.format(c1.getDate()));
        ...
        게시판1이름.setText(Integer.toString(c1.getMembername()));
        게시판1이름.setBounds(12, 430, 57, 15);
        background.add(게시판1이름);
        
        JLabel 게시판2이름 = new JLabel(Integer.toString(c2.getMembername()));
        게시판2이름.setBounds(12, 485, 57, 15);
        ...
        x_2.addActionListener(new ActionListener() {
         ...
         if(customers.size()>2) {
        	        ...
        	        게시판2이름.setText(Integer.toString(c2.getMembername()));
       ...
       게시판2.setText("");
        ...
        btnNewButton_2.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
         	 	...
         	 	x1=5;
      			x2=6;
      			StarCustomer c1 = (StarCustomer) arr1[arr1.length-5];
     	        System.out.println(c2.getMembername() + ": " + c2.getTargetScore() + " " + c2.getReview() + " " + dateFormat.format(c2.getDate()));
   			 Object[] arr = customers.toArray();
   	        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy년MM월dd일");
     	        게시판1.setText(c1.getReview());
