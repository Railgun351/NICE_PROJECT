...
public class SignUpPage2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SignUpPage2 window = new SignUpPage2();
	...
	private void initialize() {
		...
		idText.setBounds(50, 168, 433, 63);
		panel.add(idText);
		...
		pwCheck.setBounds(50, 407, 433, 63);
		...
		pwText.setBounds(50, 313, 433, 63);
...
//				dispose();
		...
		nameText.setBounds(50, 522, 433, 63);
		panel.add(nameText);
...
//		JLabel PwCheckLb = new JLabel("");
		...
		btnSignUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (id.isEmpty() || pw.isEmpty() || name.isEmpty()) {
					JOptionPane.showMessageDialog(null, "빈칸 없이 채워주세요.");
					return;
				} else {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Java2\\NICE_PROJECT\\IMG\\newsignup.png"));
